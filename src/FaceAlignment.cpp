  ...
  )
{
  ...
  if (_database == "menpo")
  {
    ...
    for (const FaceAnnotation &face : faces)
    {
      ...
      /// Check left eye and nose positions to deduce head-pose
      else if (face.parts[FacePartLabel::leye].landmarks[0].pos.x < face.parts[FacePartLabel::nose].landmarks[3].pos.x)
